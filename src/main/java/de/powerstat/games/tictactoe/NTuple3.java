...
public final class NTuple3<T1, T2, T3>
 {
  /* *
   * Cache for singletons.
   */
  // private static final Map<?, NTuple3<T1, T2, T3>> CACHE = new ConcurrentHashMap<>();
   ...
   */
  public static <T1, T2, T3> NTuple3<T1, T2, T3> of(final T1 obj1, final T2 obj2, final T3 obj3)
   {
